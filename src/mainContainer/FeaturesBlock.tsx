...
export const FeaturesBlock: React.FC = () => {
    return (
        <div className="flex flex-col max-w-7xl">
            <div className="flex flex-col items-center py-11 md:py-24">
                <span className="text-size_16 font-inter-semi text-purple700 mb-3">Features</span>
                <h2 className="text-size_30 sm:text-size_36 font-inter-semi text-gray900 text-center mb-5">All you need to run your finances effectively</h2>
                ...
                <div className="flex justify-center flex-wrap gap-5 sm:gap-x-8 sm:gap-y-16">
                    {
            ...
            <div className="flex flex-col pt-5 pb-11 md:py-24">
                <div className="mb-16">
                    <span className="text-size_16 font-inter-semi text-purple700 mb-3">Features</span>
